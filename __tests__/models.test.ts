...
describe('OpenRouter Plugin', () => {
  ...
  describe('IMAGE_DESCRIPTION Model', () => {
    test('should describe an image with IMAGE_DESCRIPTION model', async () => {
      ...
      const imageUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Gull_portrait_ca_usa.jpg/1280px-Gull_portrait_ca_usa.jpg';
    ...
    test('should describe an image with custom prompt', async () => {
      ...
      // Use a public domain test image
      const imageUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Gull_portrait_ca_usa.jpg/1280px-Gull_portrait_ca_usa.jpg';
      const customPrompt = 'Identify the species of bird in this image and provide detailed characteristics.';
